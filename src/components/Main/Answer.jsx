...
function AnswerCards({ answer, creator, createdDate }) {
  return (
    <div className='prose max-w-none mb-2'>
      <ReactQuill value={answer} readOnly={true} modules={{ toolbar: false }} />
    ...
    <div className='bg-white border border-gray-200 rounded-lg p-6 mb-4 flex flex-col gap-3'>
      <div className='flex items-start gap-4'>
        ...
        <div className='flex-1'>
          ...
          />
          {comments.length > 0 && <CommentCards comments={comments} />}
        </div>
      </div>
    </div>
  );
